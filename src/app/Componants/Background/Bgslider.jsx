          ...
          <SwiperSlide key={index}>
            <div className=" flex justify-end w-full h-1/2 border border-red-300 lg:mx-[7%]">
              ...
              >
                ...
                <div className=" md:px-5 lg:px-0 px-3  text-  w-full lg:relative absolute lg:w-fit">
                  <div
                    className={` ${
                      index % 2 == 0
                        ? "text-left"
                  ...
                  >
                    <p
                      ...
                      } w-fit    right-0 animate__animated animate__repeat animate__delay-0.9s  animate__fadeInUpBig md:text-xl lg:text-xl md text-[14px] mb-5`}
                    >
                      {d.textHead}
                    </p>
