...
function NavbarMain() {
  ...
  return (
    <div className={`w-full bg-white z-50 ${isNavbarFixed ? "fixed top-0" : ""}`}>
      <header>
        {/* Top Info Bar */}
        ...
        <div className="bg-[#2c2b49]">
          <div className="lg:w-full xl:w-[1400px] lg:px-2 mx-auto text-white flex items-center md:space-x-3 lg:space-x-3">
            {/* Top Categories */}
            ...
            {/* Slider */}
            <div className="lg:w-[30%] md:w-[25%] hidden sm:block">
              <Slider d={data} />
            </div>
            ...
            <form onSubmit={handleSearch} className="flex-grow flex">
              <div className="flex flex-grow p-2 sm:p-0 relative">
                ...
                <button
                  type="submit"
                  className="absolute right-0 top-0 bottom-0 bg-red-700 mr-2 sm:mr-0 my-2 sm:my-0 px-4 text-white"
                >
                  <FiSearch size={16} />
                </button>
              </div>
