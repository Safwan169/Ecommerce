...
const Services = () => {
  ...
  return (
    <div className="py-10 px-[3%]   duration-300 bg-gray-50">
      <div className="w-full  mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 lg:gap-20 gap-7">
